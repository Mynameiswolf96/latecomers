// student_missed/lib/src/commands/command_helpers.dart
...
class CommandHelpers {
  ...
  Future<GroupModel?> selectGroupWithDiscipline(
    ...
    final groups =
    await db.disciplineDao.getAssignedGroups(disciplineId);
  ...
  Future<DisciplineModel?> selectDisciplineFromGroup(
    ...
    final disciplines =
    await db.groupDao.getAssignedDisciplines(groupId);
